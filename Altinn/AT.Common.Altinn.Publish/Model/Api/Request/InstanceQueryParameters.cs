...
public class InstanceQueryParameters
{
    ...
    /// </summary>
    [MappedQueryParameterAttribute(QueryParameterName = _processIsCompleteParameterName)]
    public bool? ProcessIsComplete { get; set; }

    /// <summary>
    /// The process end state.
    /// </summary>
    [MappedQueryParameterAttribute(QueryParameterName = _processEndEventParameterName)]
    public string ProcessEndEvent { get; set; }

    /// <summary>
    /// The process ended value.
    /// </summary>
    [MappedQueryParameterAttribute(QueryParameterName = _processEndedParameterName)]
    public AltinnDateTimeQuery[] ProcessEnded { get; set; }

    /// <summary>
    /// The instance owner party identifier.
    /// </summary>
    [MappedQueryParameterAttribute(QueryParameterName = _instanceOwnerPartyIdParameterName)]
    public int? InstanceOwnerPartyId { get; set; }

    /// <summary>
    /// The last changed date.
    /// </summary>
    [MappedQueryParameterAttribute(QueryParameterName = _lastChangedParameterName)]
    public AltinnDateTimeQuery[] LastChanged { get; set; }

    /// <summary>
    /// The creation date.
    /// </summary>
    [MappedQueryParameterAttribute(QueryParameterName = _creationDateParameterName)]
    public AltinnDateTimeQuery[] Created { get; set; }

    /// <summary>
    /// The visible after date time.
    /// </summary>
    [MappedQueryParameterAttribute(QueryParameterName = _visibleAfterParameterName)]
    public AltinnDateTimeQuery[] VisibleAfter { get; set; }

    /// <summary>
    /// The due before date time.
    /// </summary>
    [MappedQueryParameterAttribute(QueryParameterName = _dueBeforeParameterName)]
    public AltinnDateTimeQuery[] DueBefore { get; set; }

    /// <summary>
    /// A string that will hide instances already confirmed by stakeholder.
    /// </summary>
    [MappedQueryParameterAttribute(QueryParameterName = _excludeConfirmedByParameterName)]
    ...
    /// </summary>
    [MappedQueryParameterAttribute(QueryParameterName = _confirmedParameterName)]
    public bool? Confirmed { get; set; }

    /// <summary>
    /// A value indicating whether the instance is soft deleted.
    /// </summary>
    [MappedQueryParameterAttribute(QueryParameterName = _statusIsSoftDeletedParameterName)]
    public bool? IsSoftDeleted { get; set; }

    /// <summary>
    /// A value indicating whether the instance is hard deleted.
    /// </summary>
    [MappedQueryParameterAttribute(QueryParameterName = _statusIsHardDeletedParameterName)]
    public bool? IsHardDeleted { get; set; }

    /// <summary>
    /// A value indicating whether the instance is archived.
    /// </summary>
    [MappedQueryParameterAttribute(QueryParameterName = _statusIsArchivedParameterName)]
    public bool? IsArchived { get; set; }

    /// <summary>
    /// The continuation token.
    /// </summary>
    [MappedQueryParameterAttribute(QueryParameterName = _continuationTokenParameterName)]
    public string ContinuationToken { get; set; }

    /// <summary>
    /// The page size.
    /// </summary>
    [MappedQueryParameterAttribute(QueryParameterName = _sizeParameterName)]
    public int? Size { get; set; }

    /// <summary>
    /// The instance owner identifier.
    /// </summary>
    [MappedRequestHeaderParameterAttribute(
    ...
    /// </summary>
    [MappedQueryParameterAttribute(QueryParameterName = _mainVersionIncludeParameterName)]
    ...
    /// </summary>
    [MappedQueryParameterAttribute(QueryParameterName = _mainVersionExcludeParameterName)]
    public int? MainVersionExclude { get; set; }

    /// <summary>
    /// Gets or sets the search string.
    /// </summary>
    [MappedQueryParameterAttribute(QueryParameterName = _searchStringDatabindName)]
    public string SearchString { get; set; }

    /// <summary>
    /// Gets or sets the value by which the result will be sorted.
    /// </summary>
    [MappedQueryParameterAttribute(QueryParameterName = _sortAscendingDatabindName)]
