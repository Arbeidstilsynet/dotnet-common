...
using System;
namespace Arbeidstilsynet.Common.Saksarkiv.V3.Api.V3.Saker.Item.Gjenoppta
{
    /// <summary>
    /// Builds and executes requests for operations under \api\v3\saker\{eksternId}\gjenoppta
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class GjenopptaRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Arbeidstilsynet.Common.Saksarkiv.V3.Api.V3.Saker.Item.Gjenoppta.GjenopptaRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GjenopptaRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v3/saker/{eksternId}/gjenoppta", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Arbeidstilsynet.Common.Saksarkiv.V3.Api.V3.Saker.Item.Gjenoppta.GjenopptaRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GjenopptaRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v3/saker/{eksternId}/gjenoppta", rawUrl)
        {
        }
        /// <summary>
        /// Åpne en lukket sak (asynkron) (roller: ReadWrite)
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Arbeidstilsynet.Common.Saksarkiv.V3.Api.V3.Saker.Item.Gjenoppta.GjenopptaRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Arbeidstilsynet.Common.Saksarkiv.V3.Api.V3.Saker.Item.Gjenoppta.GjenopptaRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Arbeidstilsynet.Common.Saksarkiv.V3.Api.V3.Saker.Item.Gjenoppta.GjenopptaRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
