...
namespace Arbeidstilsynet.Common.Enhetsregisteret.Model.Tenor
{
    // Root myDeserializedClass = JsonSerializer.Deserialize<Root>(myJsonResponse);
    ...
    public class Kapital
    {
        ...
        [JsonPropertyName("paalydendeBelop")]
        public string PaalydendeBelop { get; set; }
    ...
    public class TenorEnhet
    {
        ...
        [JsonPropertyName("nettadresse")]
        public string Nettadresse { get; set; }
    ...
    {
        [JsonPropertyName("hovedenhet")]
        public string Hovedenhet { get; set; }
