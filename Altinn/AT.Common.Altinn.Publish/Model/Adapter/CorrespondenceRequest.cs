...
namespace Arbeidstilsynet.Common.Altinn.Model.Adapter
{
    ...
    public class CorrespondenceRequest
    {
        ...
        [Required]
        public required List<IReceiver> Recipients { get; set; }
    ...
    /// </summary>
    public record Organization : IReceiver
    {
        /// <summary>
    ...
    /// </summary>
    public record NorwegianCitizen : IReceiver
    {
        /// <summary>
        /// SSN
        /// </summary>
    ...
    /// </summary>
    public record SelfRegisteredUser : IReceiver
    {
        /// <summary>
