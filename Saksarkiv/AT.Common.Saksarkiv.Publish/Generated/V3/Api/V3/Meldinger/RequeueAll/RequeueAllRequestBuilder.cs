...
using System;
namespace Arbeidstilsynet.Common.Saksarkiv.V3.Api.V3.Meldinger.RequeueAll
{
    /// <summary>
    /// Builds and executes requests for operations under \api\v3\meldinger\requeue-all
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class RequeueAllRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Arbeidstilsynet.Common.Saksarkiv.V3.Api.V3.Meldinger.RequeueAll.RequeueAllRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RequeueAllRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v3/meldinger/requeue-all", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Arbeidstilsynet.Common.Saksarkiv.V3.Api.V3.Meldinger.RequeueAll.RequeueAllRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RequeueAllRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v3/meldinger/requeue-all", rawUrl)
        {
        }
        /// <summary>
        /// Alle meldinger får nullstilt status og forsøkes på nytt.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Arbeidstilsynet.Common.Saksarkiv.V3.Api.V3.Meldinger.RequeueAll.RequeueAllRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Arbeidstilsynet.Common.Saksarkiv.V3.Api.V3.Meldinger.RequeueAll.RequeueAllRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Arbeidstilsynet.Common.Saksarkiv.V3.Api.V3.Meldinger.RequeueAll.RequeueAllRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
