...
public class AltinnAdapterExtensionTests
{
    ...
    private static readonly DateTime ProcessStarted = new DateTime(2025, 09, 01, 12, 0, 0);
    private static readonly DateTime ProcessEnded = new DateTime(2025, 09, 01, 13, 0, 0);
