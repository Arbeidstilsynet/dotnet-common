...
public class AltinnStorageClientExtensionsTests
{
    ...
    public async Task GetAllInstances_WhenCalledWithValidQueryParameters_ReturnsAllInstances()
    {
        ...
        _client.GetInstances(queryParameters with { ContinuationToken = "abc123" })
            .Returns(secondPage);
    ...
    public async Task GetAllInstances_WhenNextLinkIsInvalidUrl_OnlyReturnsFirstPage(string? nextLink)
    {
        // Arrange
        var queryParameters = new InstanceQueryParameters
        {
